    ...
    case "2":
      ...
      while (dogCharacteristic == "")
      {
        ...
        if (readResult != null)
        {
          ...
          searchParamsList = dogCharacteristic.Split(',');
          Array.Sort(searchParamsList);
          Console.WriteLine();
        }
      }
      ...
      for (int i = 0; i < maxPets; i++)
      {
        ...
        if (ourAnimals[i, 1].Contains("dog"))
        {
          ...
          for (int k = 0; k < searchParamsList.Length; k++)
          {
            ...
            if (dogDescription.Contains(searchParamsList[k]))
            {
              Console.WriteLine($"\nOur dog {ourAnimals[i, 3]} is a match for your search {searchParamsList[k]}");
              noMatchesDog = false;
            }
